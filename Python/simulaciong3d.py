#!/usr/bin/env python3
# simular_G3D_larga.py
# Simulación NS3D G3D (λ=2/9) con malla 64³, Tfinal=20 s, guardado cada 0.05 s
...
lamb = 2.0/9.0
save_dt = 0.05   # guardar cada 0.05 segundos
...
np.savetxt('energia_G3D_larga.csv', data, delimiter=',', header='t,energy', comments='')
print(f"Guardado energia_G3D_larga.csv con {len(times)} puntos")
